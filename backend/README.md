...
## Project Structure
    ...
    ├── testapiautoconnecto_94922  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_94922`
...
2. Clone this repo and `cd testapiautoconnecto_94922`
